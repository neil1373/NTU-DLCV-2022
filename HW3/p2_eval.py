...
for i in range(1):  # config.epoch
    checkpoint_path = "model-2/epoch_{epoch}.pth".format(epoch=i+4)
...
images_path = sorted(os.listdir('hw3_data/p2_data/images/val'))
...
for image_path in images_path:
    ...
    # print(image_path)
    image = Image.open(os.path.join('hw3_data/p2_data/images/val', image_path)).convert("RGB")
...
with open('predict6-1.json', 'w') as f:
