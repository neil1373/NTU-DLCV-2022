...
def main():
    ...
    ################ config ################
    wandb.init(project = "DLCV_hw2_p3", name = "MNISTM_SVHN_resnet34_DANN", entity="neil1373")
    config = wandb.config
    ...
    best_valid_acc = 0
    model_path = 'dann_resnet34_mnistm_svhn.pth'
    iters = 0
    ...
    for epoch in range(config.epoch):
        ...
        torch.save(feature_extractor.state_dict(), f'extractor_resnet34_mnistm_svhn.pth')
        torch.save(label_predictor.state_dict(), f'predictor_mnistm_svhn.pth')
