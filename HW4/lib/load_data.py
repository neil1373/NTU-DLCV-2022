...
from .load_blender import load_blender_data, load_test_blender_data
...
def load_data(args):
    ...
    if args.dataset_type == 'llff':
        ...
        poses, render_poses, hwf, i_split = load_test_blender_data(args.datadir, args.half_res, args.testskip)
        print('Loaded blender', images.shape, render_poses.shape, hwf, args.datadir)
        # i_train, i_val, i_test = i_split
        i_train, i_val = i_split
...
def load_test_data(args, json_path):

    K, depths = None, None
    near_clip = None

    if args.dataset_type == 'blender':
        poses, render_poses, hwf, i_split = load_test_blender_data(args.datadir, args.half_res, args.testskip, json_path)
        print('Loaded blender', hwf, render_poses.shape, hwf, args.datadir)
        # i_train, i_val, i_test = i_split
        i_test = i_split
